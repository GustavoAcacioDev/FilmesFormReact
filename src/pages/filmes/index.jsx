...
class Filmes extends Component {
    ...
    constructor(){
        ...
        this.state = {
            url : 'https://5f93ff9b9ecf720016bfc202.mockapi.io/api/filme',
            filmes : [],
            id : '',
            nome : '',
            categoria : '',
    ...
    salvar(event){
        ...
        const filme = {
          ...
          //if diferente, se condição válida ? se não :
                                    ...
                                    this.state.filmes.map((item => {
                                        return(
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    <button type="button" className="btn btn-danger" value={item.id} onClick={this.remover.bind(this)} style={{marginRight : '15px'}}>Remover</button>
